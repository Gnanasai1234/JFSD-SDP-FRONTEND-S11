...
export default function CarbohydratesGraph({ data }) {
  const { breakfastSums, dinnerSums, lunchSums, snacksSums } = data;
  const [selectedNutrient, setSelectedNutrient] = useState('Carbohydrates');
  ...
  const CarbohydratesData = [
    breakfastSums.carbohydrates,
    lunchSums.carbohydrates,
    dinnerSums.carbohydrates,
    snacksSums.carbohydrates,
  ];
  ...
  return (
    <div style={containerStyle}>
      <div style={totalCaloriesStyle}>
        ...
        Total Carbohydrates Intake: {totalcarbohydrates} kcal
      </div>
